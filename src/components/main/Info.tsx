      ...
      <ContainerInfo height={50}>
        ...
        <section className="description">
          ...
          <div className="desc">
            ...
            nihil, assumenda quasi adipisci voluptates nesciunt iste aliquam
            reiciendis commodi amet, autem architecto nisi dolore vitae maiores!
            Perferendis excepturi officia dolores!
          </div>
        </section>
